    ...
    public class UserController : Controller
    {
        ...
        public async Task<JsonResult> Delete(int userId)
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    ResultStatus = ResultStatus.Success,
                    Message = $"{user.UserName} adlı kullanıcı başarılı bir şekilde silindi",
                    User = user
                });
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var userUpdateViewModel = JsonSerializer.Serialize(new UserUpdateAjaxViewModel
                    {
                        ...
                        {
                            ResultStatus = ResultStatus.Success,
                            Message = $"{updatedUser.UserName} adlı kullanıcı başarı ile güncellenmiştir",
                            User = updatedUser
                        },
        ...
        public async Task<string> ImageUpload(string userName, IFormFile pictureFile)
        {
            ...
            string fileName = $"{userName}_{DateTime.Now.FullDateAndTimeStringWithUnderscore()}.{fileExtensions}";
