...
$(document).ready(function () {
    ...
    /* Ajax GET / Getting the _UserAddPartial as Model Form starts from here */
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (userDto.ResultStatus === 0) {
                                Swal.fire(
                                    'Silindi!',
                                    `${userDto.User.UserName} adlı kullanıcı başarı ile silindi!`,
                                    'success'
                                );
    ...
    $(function () {
        ...
        /* Ajax POST / Update a User starts from here*/
