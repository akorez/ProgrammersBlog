...
$(document).ready(function () {
    ...
    /* Ajax GET / Getting the _CategoryAddPartial as Model Form starts from here */
    ...
    $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (categoryDto.ResultStatus === 0) {
                                Swal.fire(
                                    'Silindi!',
                                    `${categoryDto.Category.Name} adlı kategori başarı ile silindi!`,
                                    'success'
                                );
        ...
        /* Ajax POST / Deleting Category ends from here */
    });
    ...
    /* Ajax POST / Update a Category starts from here*/
